...
?>
	<div class="c-product__quantity quantity">
		...
		/>
		<?php if ( ! $is_readonly ) { ?>
			<button class="h-cb c-product__quantity-minus js-quantity-minus" type="button" aria-label="<?php esc_attr_e('Decrease quantity', 'moderno'); ?>"><i class="ip-minus"></i></button>
			<button class="h-cb c-product__quantity-plus js-quantity-plus" type="button" aria-label="<?php esc_attr_e('Increase quantity', 'moderno'); ?>"><i class="ip-plus_big"></i></button>
		<?php } ?>
		<?php
		/**
